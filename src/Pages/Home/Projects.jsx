          ...
          return (
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <a target='_blank' href={projectData.link} className={`${(isHovered && hoverIndex === index) ? 'text-orange' : 'text-white'} transition-all duration-300 ease-in-out text-[12px] xs:text-[14px] sm:text-base`} onMouseEnter={() => {
                  setHoverIndex(index)
                  setIsHovered(true)
                }
                }
